...
parser = argparse.ArgumentParser(description='VGS vs. rate')
parser.add_argument(
...
# xs = np.linspace(-20, 20, 40, endpoint=False)
xs = np.arange(-20, 21)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('vgs_MP_rate_unilateral.png')
plt.show()
